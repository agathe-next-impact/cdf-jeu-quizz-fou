...
add_action( 'acf/init', function () {
	...
	// Rorschach
	$rorschach_fields = array_map( function ( $f ) {
		$f['key'] = str_replace( 'field_', 'field_rorschach_', $f['key'] );
		return $f;
	}, $fields );

	acf_add_local_field_group( [
		'key'          => 'group_rorschach_score',
		'title'        => 'Données du Score — Rorschach',
		'fields'       => $rorschach_fields,
		'location'     => [ [ [ 'param' => 'post_type', 'operator' => '==', 'value' => 'rorschach_score' ] ] ],
		'show_in_rest' => true,
	] );
	...
	$cognitif_fields = array_map( function ( $f ) {
		$f['key'] = str_replace( 'field_', 'field_cognitif_', $f['key'] );
		return $f;
	}, $fields );

	acf_add_local_field_group( [
		'key'          => 'group_cognitif_score',
		'title'        => 'Données du Score — Test Cognitif Absurde',
		'fields'       => $cognitif_fields,
		'location'     => [ [ [ 'param' => 'post_type', 'operator' => '==', 'value' => 'cognitif_score' ] ] ],
		'show_in_rest' => true,
	] );
