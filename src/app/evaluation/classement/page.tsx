...
function getRowBg(index: number): string {
  if (index === 0) return "bg-[#667eea]/10 border-[#667eea]/30";
  if (index === 1) return "bg-[#667eea]/5 border-[#667eea]/20";
  if (index === 2) return "bg-[#667eea]/[0.03] border-[#667eea]/10";
  return "bg-white border-[#667eea]/5";
}
              ...
              >
                ...
                <div className="w-12 text-center shrink-0">
                  {index < 3 ? (
                    ...
                    <span className="text-lg font-black text-[#667eea]/40">
                      #{index + 1}
                    </span>
                  )}
                </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-[#667eea]/40 font-medium">
                    {player.title}
                  </div>
                </div>
                ...
                <div className="text-right shrink-0">
                  <div className="text-2xl font-black text-[#667eea]">
                    {player.score}
                  </div>
                  <div className="text-xs text-[#667eea]/30 font-medium">
                    pts
                  </div>
                </div>
              </div>
